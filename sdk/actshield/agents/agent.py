...
if TYPE_CHECKING:
    ...
    from actshield.delegation.delegation import DelegationScope
    from actshield.tracing.correlation import SpanScope


class Agent:
    """Represents a registered AI Agent within the ActShield platform."""

    def __init__(self, identity: AgentIdentity, guard: Optional["ActShield"] = None) -> None:
    ...
    def delegate(
        ...
        if self.guard is None:
            raise RuntimeError("Agent is not attached to an ActShield instance.")
