...
class ApiService:
    ...
    def evaluate_policy(
        ...
        """
        from actshield.tools.tool import ToolDefinition, ToolRequest, SensitivityLevel
        ...
        from actshield.tracing.correlation import CorrelationContext, generate_id as gid
