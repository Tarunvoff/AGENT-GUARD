...
the rest of actshield.  The PolicyEvaluator reads structured fields
...
class EvidenceTriad(BaseModel):
    ...
    observed: List[str] = Field(
        ...
        description="Facts directly present in the ActShield evidence packet.",
    )
...
class AISecuraAnalysis(BaseModel):
    ...
    The ActShield PolicyEvaluator is the sole enforcement authority.
    ...
    ai_unavailable: bool = Field(
        ...
        description=(
            ...
            "When True, ActShield deterministic policy continues as sole enforcer."
        ),
    )
