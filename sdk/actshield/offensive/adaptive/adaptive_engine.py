...
from actshield.offensive.attack import AttackCase, AttackType
...
logger = logging.getLogger("actshield.offensive.adaptive.engine")


class AdaptiveEngine:
    """Orchestrates adaptive multi-depth offensive campaigns against ActShield defenses."""
