"""ActShield Offensive Validation Engine — Orchestrating continuous security evaluation."""
...
from actshield.offensive.corpus import AttackCorpus, attack_corpus
...
logger = logging.getLogger("actshield.offensive.engine")
...
class OffensiveEngine:
    ...
    def execute_attack(
        ...
        target = target or self.registry.get("ActShield-demo")
    ...
    def export_reports(
        ...
        md_content = (
            f"# ActShield Offensive Validation Campaign Report\n\n"
