"""
ActShield Security AI Provider — Base Protocol
================================================
...
If all providers fail, ActShield fails-safe to deterministic deny.
"""
...
class SecurityAIProvider(ABC):
    """
    Abstract base for all ActShield AI intelligence providers.
