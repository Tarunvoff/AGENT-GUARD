...
from actshield.tools.tool import Resource, SensitivityLevel, ToolDefinition, ToolRequest, ToolResult
from actshield.tracing.correlation import generate_id, get_current_context
...
def protected_tool(
    ...
    """Decorator to register and wrap a tool function with ActShield security enforcement."""
    ...
    **kwargs: Any,
    ...
    if decision.is_blocked:
        raise PermissionError(
            f"ActShield Policy Enforced: Tool '{tool_def.name}' invocation BLOCKED. "
