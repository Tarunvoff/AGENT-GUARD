"""AgentGuard Multi-Agent Topology & Graph Visualizer for CLI."""
...
from agentguard.agents.identity import AgentStatus, AgentTrustLevel
from agentguard.client import AgentGuard


def render_agent_topology(guard: Optional[AgentGuard] = None) -> None:
    ...
    console.print(
        Panel(
            tree,
            title="[bold magenta]🛡️  AGENTGUARD MULTI-AGENT SECURITY TOPOLOGY[/bold magenta]",
