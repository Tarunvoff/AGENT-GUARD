"""AgentGuard System Diagnostic & Doctor Utility."""
...
def run_doctor(guard: Optional[AgentGuard] = None, json_output: bool = False) -> int:
    """Run comprehensive AgentGuard subsystem diagnostics."""
    console = Console()
    ...
    # 2. AgentGuard SDK & Config
    checks.append(("AgentGuard SDK Core", "v0.9.0 Initialized", "OK", True))
    ...
    table = Table(
        title="[bold magenta]🛡️  AGENTGUARD SYSTEM DIAGNOSTICS & DOCTOR[/bold magenta]",
