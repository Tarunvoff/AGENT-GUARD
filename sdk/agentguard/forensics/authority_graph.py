...
from agentguard.forensics.models import AuthorityRelationship, DelegationRelationship
...
class AuthorityGraph:
    """Directed authority graph built from the AgentGuard delegation registry.
    ...
    @classmethod
    def from_guard(cls, guard: "AgentGuard") -> "AuthorityGraph":
        """Construct graph from an AgentGuard instance's delegation registry."""
        g = cls()
