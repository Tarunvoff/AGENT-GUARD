...
from agentguard.forensics.explanation import ForensicExplainer
...
from agentguard.forensics.snapshots import SnapshotStore, capture_snapshot
from agentguard.offensive.results import OffensiveAttackResult
...
class ForensicService:
    ...
    Attach to an AgentGuard instance and call record_* methods from
    ...
    def export_all(self, output_dir: str = "reports/forensics") -> Dict[str, str]:
        ...
        import os
        from agentguard.forensics.serializers import export_json
