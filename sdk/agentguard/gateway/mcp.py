...
class MCPGateway:
    ...
    def register_mcp_tool(
        ...
        """Register an upstream MCP tool with AgentGuard security governance."""
        ...
        # Register corresponding protected tool definition in AgentGuard
    ...
    def handle_message(self, message: Union[str, Dict[str, Any], MCPMessage]) -> MCPMessage:
        """Process incoming MCP JSON-RPC message, enforcing AgentGuard security policies."""
        ...
        if method == "tools/list":
            ...
            return MCPMessage(id=msg_id, result={"status": "pong", "gateway": "AgentGuard MCP Gateway"})
        else:
            return MCPMessage(
                id=msg_id,
                error={
                    "code": -32601,
                    "message": f"Method '{method}' not supported by AgentGuard MCP Gateway",
                },
            )
    ...
    def _handle_tools_call(self, msg_id: Union[str, int], params: Dict[str, Any]) -> MCPMessage:
        ...
        if decision.is_blocked:
            return MCPMessage(
                ...
                error={
                    "code": -32000,
                    "message": f"AgentGuard Security Block: [{decision.reason_code}] {decision.explanation}",
                    "data": {
    ...
    def _handle_resources_read(self, msg_id: Union[str, int], params: Dict[str, Any]) -> MCPMessage:
        ...
        return MCPMessage(
            ...
            result={
                ...
                "_agentguard": {"context_id": ctx.context_id, "taint_state": ctx.taint_state.value},
            },
        )
