"""Deterministic rules for automatic incident creation in AgentGuard Phase 9."""

from __future__ import annotations

from typing import Any, Dict, Optional, Tuple
from agentguard.incidents.incident_state import IncidentSeverity
...
class IncidentCreationRule:
    ...
    def evaluate_threat_event(
        ...
        from agentguard.incidents.incident_state import IncidentState
