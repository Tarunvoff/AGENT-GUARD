...
from agentguard.integrations.ai_secura import SecurityContext, SecurityAnalysis
...
logger = logging.getLogger("agentguard.ollama")
...
class OllamaAISecuraAdapter:
    ...
    def analyze(self, context: SecurityContext, apiris_result: Optional[APIAnalysis] = None) -> AISecuraAnalysis:
        ...
        1. Build structured security packet from AgentGuard objects.
        ...
        user_prompt = (
            "Analyze the following AgentGuard security evidence packet and "
    ...
    def _analyze_local_heuristic(
        ...
        from agentguard.integrations.ai_secura_analysis import EvidenceTriad, AuthorityAnalysis, TaintAnalysis
