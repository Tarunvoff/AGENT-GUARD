...
from agentguard.offensive.target import AttackTarget, TargetEnvironment, target_registry
...
class VulnerableDemoTarget:
    ...
    def remediate_and_replay(cls, attack: AttackCase) -> OffensiveAttackResult:
        """Apply full AgentGuard security policies, replay the exact same attack, and verify BLOCK."""
        start_t = time.perf_counter()
